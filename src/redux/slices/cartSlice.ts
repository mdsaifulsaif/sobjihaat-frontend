...
interface CartState {
    ...
    totalPrice: number;
    isMiniCartOpen: boolean;
    placingOrder: boolean; // ✅ নতুন — checkout submit চলাকালীন loading/disable state (global, যাতে FloatingCartButton-ও জানতে পারে)
}
...
const cartSlice = createSlice({
    ...
    reducers: {
        ...
        // ✅ নতুন reducer — order placing চলাকালীন global loading state track করবে
