...
/* ---------------------------------------------------------------------------
   Skeleton Loader (Hydration Issue এড়াতে শুধু Swiper-এর সময় প্রয়োজন হলে)
--------------------------------------------------------------------------- */
...
const HomeCategory: React.FC<HomeCategoryProps> = ({ initialCategories = [] }) => {
  ...
  // Swiper স্লাইডার ক্লায়েন্টে রেন্ডার নিশ্চিত করতে
  useEffect(() => {
    setIsMounted(true);
  }, []);

  // ডাটা সর্ট এবং ফিল্টার (অপ্রয়োজনীয় API কল একদম বন্ধ)
  ...
  if (!categoriesData.length) {
    return null; // ডাটা না থাকলে কিছুই দেখাবে না
  }
