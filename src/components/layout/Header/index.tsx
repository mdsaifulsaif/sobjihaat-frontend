...
import { closeMobileMenu, openComplainModal, toggleMobileMenu } from "@/redux/slices/uiSlice";
...
<div className="flex items-center justify-between pb-4 border-b border-gray-100 mb-4">
  ...
  <button
    onClick={() => dispatch(openComplainModal())}
    className="flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-[var(--color-primary)] transition-all"
  >
