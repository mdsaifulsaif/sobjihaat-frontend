        ...
        <div className="flex flex-wrap justify-start gap-2 md:gap-4">
          {products.map((product: any) => (
            <div
              key={product._id}
              /* 
           mobile: w-[calc(33.33%-8px)] -> ৩ কলাম (gap 2*4px=8px বা ৩টির জন্য ৩টি গ্যাপ ৮ পিক্সেল)
           md: 191px -> ট্যাবলেট বা বড় স্ক্রিনে আগের মতো ফিক্সড সাইজ
        */
              className="w-[calc(33.33%-6px)] sm:w-[calc(33.33%-8px)] md:w-[191px] lg:w-[191px] flex-shrink-0"
            >
              <ProductCard
                product={{
                  id: product._id,
