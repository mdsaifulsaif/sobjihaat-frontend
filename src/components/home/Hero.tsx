...
const Hero: React.FC = () => {
  ...
  return (
    <div className="mx-auto container px-4">
      {/* Banner */}
      <div
        className="relative w-full overflow-hidden rounded-2xl bg-gray-100 bg-center bg-no-repeat
                   bg-cover min-h-[180px] max-h-[50vh]
                   sm:min-h-[480px] sm:max-h-none"
        style={{ backgroundImage: `url(${bannerUrl})` }}
      >
        {/* White gradient overlay — left side */}
        <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/80 to-transparent z-0 pointer-events-none" />
        ...
        {/* Bottom glass feature bar (md+ only) */}
