...
//   return (
//     <div className="flex items-start bg-gray-50 min-h-screen container">
//       {/* Static Sidebar (Left) */}
//       <aside className="hidden md:block w-[240px] lg:w-[260px] flex-shrink-0 sticky top-0 h-screen overflow-y-auto border-r border-gray-100 bg-white custom-scrollbar z-40">
//         <SidebarCategories />
//       </aside>
...
const CategoryPage = () => {
  ...
  return (
    ...
    <div className="flex items-start bg-white min-h-screen container">
      ...
      <aside
        className="hidden md:block w-[240px] lg:w-[260px] flex-shrink-0 sticky overflow-y-auto border-r border-gray-100 bg-white custom-scrollbar z-30"
        style={{
