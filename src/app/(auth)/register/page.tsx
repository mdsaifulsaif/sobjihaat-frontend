...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Register er por manually credentials diye auto sign-in kore dicchi
            // jate user abar login form e giye email/password type na kore
            ...
            if (res?.error) {
                // auto-login fail korle o account toh create hoyeche, tai login page e pathiye dicchi
