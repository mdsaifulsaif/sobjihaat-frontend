            ...
            <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 flex justify-between items-center">
                ...
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2 text-[13px] text-gray-600">
                        ...
                        <a href="tel:01753923093" className="hover:text-[var(--color-primary)] transition-all">01783176838</a>
                    </div>
                    <div className="flex items-center gap-2 text-[13px] text-gray-600">
                        <BsWhatsapp className="text-[var(--color-primary)]" size={14} />
                        <a href="https://wa.me/01322840808" className="hover:text-[var(--color-primary)] transition-all">01522114096</a>
                    </div>
                </div>
